import{_ as a,c as i,o as n,ak as l}from"./chunks/framework.CK5UQgAU.js";const p="/settings.png",o=JSON.parse('{"title":"配置","description":"","frontmatter":{},"headers":[],"relativePath":"guide/configure.md","filePath":"guide/configure.md"}'),e={name:"guide/configure.md"};function t(h,s,k,d,E,r){return n(),i("div",null,[...s[0]||(s[0]=[l(`<div style="display:none;" hidden="true" aria-hidden="true">Are you an LLM? You can read better optimized documentation at /guide/configure.md for this page in Markdown format</div><h1 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to &quot;配置&quot;">​</a></h1><h2 id="环境配置" tabindex="-1">环境配置 <a class="header-anchor" href="#环境配置" aria-label="Permalink to &quot;环境配置&quot;">​</a></h2><p>默认提供三套环境配置，分别为：</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-CO6uy" id="tab-OwhZ6Hn" checked><label data-title=".env.development 开发环境" for="tab-OwhZ6Hn">.env.development 开发环境</label><input type="radio" name="group-CO6uy" id="tab-EBg5h4X"><label data-title=".env.test 测试环境" for="tab-EBg5h4X">.env.test 测试环境</label><input type="radio" name="group-CO6uy" id="tab-mxZlMkW"><label data-title=".env.production 生产环境" for="tab-mxZlMkW">.env.production 生产环境</label></div><div class="blocks"><div class="language-yaml vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 应用配置面板</span></span>
