import{_ as s,c as a,o as i,a4 as n,a7 as l}from"./chunks/framework.B11lDh7E.js";const y=JSON.parse('{"title":"配置","description":"","frontmatter":{},"headers":[],"relativePath":"guide/configure.md","filePath":"guide/configure.md"}'),p={name:"guide/configure.md"},e=n(`<h1 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to &quot;配置&quot;">​</a></h1><h2 id="环境配置" tabindex="-1">环境配置 <a class="header-anchor" href="#环境配置" aria-label="Permalink to &quot;环境配置&quot;">​</a></h2><p>默认提供三套环境配置，分别为：</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-4vHJk" id="tab-VXFJ_eo" checked="checked"><label for="tab-VXFJ_eo">.env.development 开发环境</label><input type="radio" name="group-4vHJk" id="tab-AnyzMYX"><label for="tab-AnyzMYX">.env.test 测试环境</label><input type="radio" name="group-4vHJk" id="tab-MlYnq-v"><label for="tab-MlYnq-v">.env.production 生产环境</label></div><div class="blocks"><div class="language-yaml vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 应用配置面板</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 是否在打包后生成存档，支持 zip 和 tar</span></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">VITE_BUILD_ARCHIVE =</span></span></code></pre></div></div></div><p>其中 <code>VITE_APP_SETTING</code> <code>VITE_APP_TITLE</code> <code>VITE_APP_API_BASEURL</code> <code>VITE_APP_DEBUG_TOOL</code> 为必要配置，即不管是在开发、测试，还是生产环境都需要使用到。而其余配置则在不同环境下有不同用途，例如开发环境用于本地开发使用，测试环境和生产环境用于构建使用。</p><p>开发者可根据实际业务需求进行扩展，如果对这块不熟悉，请阅读 <a href="https://cn.vitejs.dev/guide/env-and-mode.html" target="_blank" rel="noreferrer">Vite - 环境变量和模式</a> 章节。</p><div class="warning custom-block"><p class="custom-block-title">注意</p><p><code>VITE_APP_SETTING</code> 该变量是开启应用配置面板，目的是方便开发者在开发阶段调试，生产环境下默认关闭，也建议关闭。</p><p>如果希望提供用户一些定制化的能力，可以开启偏好设置，详细可阅读《<a href="./preferences.html">用户偏好设置</a>》。</p></div><h2 id="应用配置-框架配置" tabindex="-1">应用配置（框架配置） <a class="header-anchor" href="#应用配置-框架配置" aria-label="Permalink to &quot;应用配置（框架配置）&quot;">​</a></h2><p>请在 <code>/src/settings.ts</code> 文件中进行配置，而 <code>/src/settings.default.ts</code> 为框架的默认配置，请勿在该文件内修改。</p><p>关于配置的类型定义，可以在 <code>/src/types/globals.d.ts</code> 文件中查阅。</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 这是基础版演示源码里的自定义配置示例</span></span>
